...
| profile | String | Profile parameter controls the format and richness of the response. See [the possible values of the profile parameter](#the_possible_values_of_the_profile_parameter). |
